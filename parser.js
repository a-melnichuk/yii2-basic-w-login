		...
		parse: function (expr) {
			...
			while (this.pos < this.expression.length) {
				if (this.isOperator()) {
					...
					if ((expected & FUNCTION) === 0) {
						this.error_parsing(this.pos, "unexpected function, check if operators +,-,*,/ are present and function is correct.");
					}
					this.addfunc(tokenstack, operstack, TOP1);
					noperators++;
					expected = (LPAREN);
					...
					if ((expected & PRIMARY) === 0) {
						this.error_parsing(this.pos, "unexpected variable, check if operators +,-,*,/ are present.");
					}
